...
export default function Form({ onInfoChange,  step }) {
    ...
    const handleSelect = (ticket) => {
        ...
        onInfoChange(["selectedTicket", ticket]);
    }
    ...
    return (
        <div className=' flex place-items-center justify-center max-w-full h-screen bg-gradient-to-b from-black/93 to-alpha'>
            ...
            <div className='p-3 place-items-center max-h-fit rounded-xl border md:w-[45%] w-[75%] border-img'>
                ...
                {step === 1 ? (
                    ...
                    <form className='flex  justify-center border-img flex-col md:w-fit w-[90%] m-auto gap-2.5 border rounded-2xl p-3'
                            ...
                            <div className='md:flex  md:place-self-center justify-self-center justify-evenly grid-cols-3 gap-2 md:w-fit'>
                                {ticketOptions.map((ticket) => (
                                    <button
                                        ...
                                        className={`flex relative md:mb-0 mb-2 justify-start place-items-center  p-2 border-2 md:h-[3.5rem] h-[4rem] w-[9.5rem] md:w-[8rem] cursor-pointer rounded-lg bg-primary border-img  ${selectedTicket?.id === ticket.id ? "border-[#00a8e8] bg-[#08343C] shadow-lg scale-105" : "border-gray-600"}`
                                        }
                                    >
                                        ...
                                        <span className="absolute md:left-21 left-26 md:top-3.5 top-7.5 bg-img w-[2.3rem] rounded-md">
